...
export class Planet {
    ...
    setEarthViewPosition () {
        alert (222);
/*
        rotatedPosition = tf.matMul (this.solarSystem.planetarium.rotZyxMat, tf.vecSub (this.equatPosition, this.solarSystem.earth.equatPosition));
*/
        var rotatedPosition = tf.matMul ([[1, 0, 0], [0, 1, 0], [0, 0, 1]], tf.vecSub (this.equatPosition, this.solarSystem.earth.equatPosition));
